	...
	<div class="card card-outline card-primary">
		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					<label for="short_name" class="control-label">Nombre IA</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Mensaje sin Resultado</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Logotipo IA</label>
				<div class="custom-file">
			...
			<div class="form-group">
				<label for="" class="control-label">Imagen Usuario</label>
				<div class="custom-file">
