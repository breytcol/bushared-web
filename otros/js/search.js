                    ...
                    for (var i in words) {
                        ...
                        if (i == (words.length - 1)) {
                            if (self.itemsFound.length > 0) {
                                ...
                                $('#js-alert-info .alert-info').html('No se ha encontrado coincidencias, intenta validar lo que buscas. <br> "Actualizaremos nuestras bases de datos basándonos en las búsquedas nuevas de los usuarios."');
                ...
                if (page <= total && page > 0) {
                    if (next <= total) {
                        if (page == 1) {
                            ...
                            <li><a href="search.php?js=' + self.parameters.js + '&page=' + next + '">&raquo;</a></li>\
                        ');
                        } else {
                            $.pagination = ('\
                            <li><a href="search.php?js=' + self.parameters.js + '&page=' + prev + '">&laquo;</a></li>\
                            <li><a href="search.php?js=' + self.parameters.js + '&page=' + next + '">&raquo;</a></li>\
                        ');
                        }
                    } else {
